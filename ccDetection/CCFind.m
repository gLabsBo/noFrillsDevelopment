...
%% parameters
K = round(min(size(I,1),size(I,2))/15); %Margin in the image where we assume that there is no colorChecker
...
% figure(4), subplot(1,2,1), imshow(E)
% subplot(1,2,2), imshow(E0)
...
%% analyze CC
[C, rgb] = analyzecc(X,I,colorImage);
